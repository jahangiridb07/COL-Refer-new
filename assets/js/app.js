(() => {
  ...
  // Plan catalog (optional): editable JSON embedded in new-connection.html
  ...
  function initStep1(){
    ...
    vpContinue?.addEventListener("click", () => {
      ...
      window.location.href = "installation-details.html";
    });
  ...
  function initStep2(){
    ...
    $("#selClose")?.addEventListener("click", () => {
      ...
      window.location.href = "../../new-connection.html";
    });
